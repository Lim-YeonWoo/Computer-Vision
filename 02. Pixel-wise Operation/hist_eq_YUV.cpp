...
int main()
{
	...
	// write PDF
	for (int j = 0; j < 3; j++)
	{ // blue의 PDF, equalized PDF 적고, green의 ..., red의...
		fprintf(f_PDF_RGB, "PDF for %d \n", j);
		fprintf(f_equalized_PDF_YUV, "PDF for %d \n", j);
